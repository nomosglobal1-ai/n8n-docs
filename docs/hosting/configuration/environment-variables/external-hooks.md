...
You can define external hooks that n8n executes whenever a specific operation runs. Use them to log data, change data, or forbid an action by throwing an error.
